...
BaseType_t serial_init(void)
{
    ...
    Serial_Config.USART_Parity              = USART_Parity_Even;
    Serial_Config.USART_StopBits            = USART_StopBits_1;
    Serial_Config.USART_WordLength          = USART_WordLength_9b;

    /* Initialize and configure Hardware */
    bb_dbg_init(&Serial_Config);
    ...
    /* Enable hardware */
    bb_dbg_enable(OS_ISR_PRIORITY_SER);
